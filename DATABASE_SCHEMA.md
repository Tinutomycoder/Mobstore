...
date_joined	datetime	—	Not Null	Account creation date-time
Table 7.1: auth_user

Table 7.2: store_category
Column Name	Data Type	Size	Constraints	Description
